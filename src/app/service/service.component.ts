...
export class ServiceComponent implements OnInit {
  ...
  supportFee:any
  home:any
  constructor(private activatedRoute: ActivatedRoute,private modalService: BsModalService,private adminService:AdminService,private router : Router,private loginService: LoginService,private formBuilder: FormBuilder,private ngxService: NgxUiLoaderService,private toastr: ToastrService) {}
 min = new Date();
  ngOnInit(): void {
    ...
    let id = this.activatedRoute.snapshot.paramMap.get('serviceId');
     ...
     let q3 = this.loginService.getsubcategoryDetails(id)
  ...
  book(template){
    ...
    if(this.bookingForm.value.hours != 2){
