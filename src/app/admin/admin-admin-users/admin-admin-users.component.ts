...
this.ngxService.start()
    this.adminService.getListUsersAdmin().subscribe(
      res => {
  ...
  if (this.signupForm.invalid) {
     ...
     // formData.append('ns', this.signupData.ns);
      formData.append('first_name', this.signupData.name);
      formData.append('email', this.signupData.email);
      formData.append('password', this.signupData.password);
      formData.append('last_name', this.signupData.lname);
      formData.append('phone', this.signupData.phone);

      this.loginService.registerUserAdmin(formData).subscribe((result) => {
        this.ngxService.stop();
  ...
  updateUser(template:any,userDetails){
   console.log(userDetails.country_code)
    ...
    this.infos.fname = userDetails.first_name;
   ...
   // this.infos.ns = userDetails.ns;
    ...
    this.updateInfo.controls['country'].setValue(userDetails.country_code);
  ...
  update(){
      ...
      //  formData.append('id', this.infos.id);
       formData.append('first_name', this.infos.fname);
       formData.append('email', this.infos.email);
       formData.append('last_name', this.infos.lname);
