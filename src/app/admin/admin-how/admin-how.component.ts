...
@Component({
  selector: 'app-admin-how',
  templateUrl: './admin-how.component.html',
  styleUrls: ['./admin-how.component.css']
})
export class AdminHowComponent implements OnInit {
  urls:any;
  public files: any[];
  ...
  ngOnInit() {
    ...
    this.adminService.how().subscribe(
      res => {
...
confirm(){
  ...
  this.adminService.addHow(formData).subscribe((result) => {
