...
@Component({
  selector: 'app-admin-learn-more',
  templateUrl: './admin-learn-more.component.html',
  styleUrls: ['./admin-learn-more.component.css']
})
export class AdminLearnMoreComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.adminService.learnMore().subscribe(
      res => {
...
confirm(){
 ...
 //  formData.append('id', this.infos.id);
  ...
  this.adminService.addLearnMore(formData).subscribe((result) => {
